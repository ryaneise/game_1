...
function finalMission() {
    ...
    if (margin >= 3) {
        ...
        showScene(
            "LINK FAILURE",
            "<p>The carrier is weak. The decoder cannot recover the music.</p>" +
            "<p><b>FINAL MARGIN: " +
            margin.toFixed(2) +
            " dB</b></p>" +
            "<p>The satellite emits one sad guitar squeal and goes quiet.</p>",
            [
                {
                    text: "REDESIGN THE LINK",
                    action: frequencyScene
                }
            ]
        );
